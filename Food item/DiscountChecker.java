public class DiscountChecker {
    ...
    public static boolean isEligibleForDiscount(int age, boolean hasMembership, String promoCode) {
        ...
        boolean isVIP = hasPromo || (isSenior && isMember );
    ...
    public static void main(String[] args) {
        ...
        // Expected result: true (qualifies for Standard)

        System.out.println("Is eligible for discount? " + isEligibleForDiscount(30, true, "")); // Should be true
